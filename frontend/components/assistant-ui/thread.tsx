    ...
    <ThreadPrimitive.Empty>
      <div className="flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
        <div className="flex w-full flex-grow flex-col items-center justify-center">
            <h2 className="text-xl font-semibold text-foreground">Welcome to OnChain Ally!</h2> 
          <p className="mt-4 font-medium text-center">
           Friendly guide to help you navigate the blockchain world.
          </p>
        </div>
      ...
      <Popover>
        <PopoverTrigger
          className="w-full px-4 py-2 text-white rounded-lg font-medium flex items-center justify-center transition-colors"
          style={{
...
const HistoricalChartSuggestions = () => {
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <SuggestionTemplate prompt="Show me Bitcoin's price history for the past year">
        Show me Bitcoin&apos;s price history for the past year
      </SuggestionTemplate>
      <SuggestionTemplate prompt="How has Ethereum performed compared to Bitcoin in the last year?">
        How has Ethereum performed compared to Bitcoin in the last Year?
      </SuggestionTemplate>
